...
c)?"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=":c.currentSrc||c.src;if("A"===f&&"href"===b)return d?"#":"";if(K(b,["srcset","integrity","crossorigin"])||fj.test(b)||"IFRAME"===f&&"src"===b||"SCRIPT"===f&&K(b,["src","type"]))return null}return d}function Yd(a,c,b,d){void 0===d&&(d="wv2");return{X:function(e,f){return C(a,d+"."+b+"."+f,e,void 0,c)}}}function If(a,c,b,d){if(c){var e=[];c&&(a.document.documentElement.contains(c)?
